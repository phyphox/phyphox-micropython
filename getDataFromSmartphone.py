...
def main():
    ...
    #Experiment
    getDataFromSmartphone = phyphoxBleExperiment.PhyphoxBleExperiment()   #generate experiment on Arduino which plot random values
    ...
    #Edit
    Interval = phyphoxBleExperiment.PhyphoxBleExperiment.Edit() 
